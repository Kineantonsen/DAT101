...
export const gameProps = {
  ...
  ColorButtons: [
    ...
    ButtonStartEnd: new libSprite.TSpriteButton(spcvs, SpriteInfoList.ButtonStartEnd, SpriteInfoList.ButtonStartEnd.dst, lib2d.TCircle),
    GameSpeed: 800, 
...
function setMouseUp(){
  ...
  if(gameProps.seqIndex < gameProps.sequence.length - 1){
    ...
    //Her er siste knappen i sekvensen
    gameProps.activeButton.onMouseUp();
